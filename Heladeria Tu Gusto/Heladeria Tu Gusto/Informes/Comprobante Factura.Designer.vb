...
Partial Class Comprobante_Factura
    ...
    Friend WithEvents TablaFacturaBindingSource As System.Windows.Forms.BindingSource
    Friend WithEvents DatasetFactura As Heladeria_Tu_Gusto.datasetFactura
End Class
