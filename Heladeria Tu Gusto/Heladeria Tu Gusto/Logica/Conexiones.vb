...
Public Class Conexiones
    ...
    Private ReadOnly _cadenaConexion As String = "Provider=SQLNCLI11;Data Source=RODRIGO-PC\SQLEXPRESS;Integrated Security=SSPI;Initial Catalog=HeladeriaTuGusto"
